...
class OmniauthTwitterAuthenticationTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test 'Login to site via Twitter' do
    post_via_redirect '/users/auth/twitter/callback', {uid: '1'}
    assert_response :success
    assert_match 'Confirm your details', response.body
  end

  test 'Error when trying Twitter' do
